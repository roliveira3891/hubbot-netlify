      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="md:text-right">
            <h2 className="font-semibold text-foreground mb-4">Fale Conosco</h2>
            {/* <p className="text-muted-foreground mb-2">suporte@hubbot.io</p> */}
            <a
              href={whatsappUrl()}
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Fale com a HubBot no WhatsApp"
              className="inline-flex md:justify-end items-center gap-2 mb-4 text-muted-foreground hover:text-foreground transition-colors"
            >
            ...
            <div className="flex md:justify-end items-center gap-4">
              <a target="_blank" rel="noopener noreferrer" aria-label="HubBot no LinkedIn" href="https://www.linkedin.com/company/hubbot-io" className="text-muted-foreground hover:text-foreground transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              <a target="_blank" rel="noopener noreferrer" aria-label="HubBot no Instagram" href="https://www.instagram.com/hubbot.io/" className="text-muted-foreground hover:text-foreground transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
